...
SELECT
	DISTINCT NationalCode, Li.Id As ErrorListID, Ep.Id AS ErrorEmpID
FROM
	Eris.dbo.Salary
	JOIN Eris.dbo.List AS Li ON Eris.dbo.Salary.ListId = Li.Id
	JOIN Eris.dbo.Employer AS Em ON Em.Id = Li.UserId
	JOIN Eris.dbo.CompEmp AS Cm ON Cm.UserId = Em.Id
...
WHERE
	...
	AND (
		...
		FROM Eris.dbo.Salary
			...
			JOIN Eris.dbo.CompEmp ON Eris.dbo.List.UserId = Eris.dbo.CompEmp.UserId
